...
const Radar = function (size, radar) {
  ...
  function plotRadarHeader () {
    ...
    header.select('.radar-title')
      ...
      .html('<a href="https://www.vivy.com/"> <img src="/images/logo.png" /> </a>')
  ...
  function plotRadarFooter () {
    ...
    const ul = p.append('tr')
      .append('td')
      .append('h3')
      .text('What is the Tech Radar?')
      .append('p')
      .text('Vivy Tech Radar is a list of technologies that we have assessed and experienced with our production usage and internal assesment:')
      .append('ul')
      ul.append('li')
        .html('<strong>ADOPT</strong> — Technologies that we have a great deal of confidence in to serve our purpose. Proven low risk technologies that are widely used in the Vivy production environment and that we recommend using.')
      ul.append('li')
        .html('<strong>TRIAL</strong> — Slightly risky technologies, but seen some prototypes and research. Some engineers have the knowledge or the solutions to some real problems and they have the experience in the organization.')
     ul.append('li')
        .html('<strong>ASSESS</strong> — High risk technologies, but great potential for us. It is great to invest some time in prototyping and research. Very few engineers have the knowledge and they promote it in the organization.')
      ul.append('li')
        .html('<strong>HOLD</strong> — Technologies not recommended for new projects. This technology is to support existing projects and is not recommended.')
    p.append('p').html('Based on <a href="https://www.thoughtworks.com"> Thoughtworks</a>. ' +
